const galleryCards = [
  ...
  },
  {
    ...
    caption: "A tidy, colorful way to preview showcases, club events, and competition moments.",
    theme: "bg-[linear-gradient(145deg,#fff7da,#ffe8a6)]",
    badge: "Calendar",
  },
  {
    title: "Stories From the Rink",
    caption: "Readable cards for interviews, mentor notes, and inspiring skater experiences.",
    ...
    <section id="gallery" className="section-spacing pb-20">
      <div className="section-shell">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="section-title mt-4">
              A layout that can grow into more pages, posts, and club features.
            </h2>
          </div>
          <p className="section-copy max-w-xl">
            These preview panels suggest how the project can expand later while
            keeping the same curated visual language across sections.
          </p>
        </div>
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-[1.15fr_0.85fr]">
            ...
            <div className="grid gap-5 md:grid-cols-[1fr_0.88fr]">
              <div className="rounded-[2rem] bg-[linear-gradient(160deg,#2e8b86,#1f4f67)] p-7 text-white">
                ...
                <h3 className="display-title mt-4 text-4xl leading-tight">
                  Built as a strong landing page with room to expand into a full
                  skating resource website.
                </h3>
              ...
              <div className="space-y-4">
                {galleryCards.slice(0, 2).map((card) => (
                  <div key={card.title} className={`rounded-[1.8rem] p-5 ${card.theme}`}>
          ...
          <article className={`hover-lift rounded-[2.2rem] border border-[var(--color-border)] p-6 shadow-[var(--shadow-soft)] ${galleryCards[2].theme}`}>
            ...
            <h3 className="display-title mt-4 text-3xl">{galleryCards[2].title}</h3>
            ...
            <div className="mt-8 rounded-[1.8rem] border border-[rgba(35,48,71,0.08)] bg-white/70 p-5">
              ...
              <p className="mt-3 text-[0.96rem] leading-7 text-[var(--color-muted)]">
                A future interview section could share short, uplifting stories
                from skaters, parents, coaches, and community organizers.
              </p>
            </div>
          </article>
        </div>
